...
export const translations = {
  en: {
    ...
    services: {
      ...
      items: [
        { icon: '⚡', title: 'Electrical Works', desc: 'High & medium voltage installations, substation construction, and power distribution systems.' },
        { icon: '⚙️', title: 'Mechanical Works', desc: 'HVAC, plumbing, fire-fighting systems and mechanical utility installations.' },
        { icon: '🏗️', title: 'Civil Works', desc: 'Structural construction, civil foundations, and infrastructure development.' },
        { icon: '🔌', title: 'Power Systems', desc: 'Switchgear, transformers, generators, and UPS systems supply and installation.' },
        { icon: '💡', title: 'Lighting Solutions', desc: 'Street lighting, industrial lighting and smart lighting control systems.' },
        { icon: '🛡️', title: 'Maintenance & O&M', desc: 'Preventive and corrective maintenance contracts for electrical networks.' },
      ],
      cta: 'All Services',
    },
    /* ── Projects ── */
  ...
  ar: {
    ...
    services: {
      ...
      items: [
        { icon: '⚡', title: 'الأعمال الكهربائية', desc: 'تركيبات الجهد العالي والمتوسط، وإنشاء المحطات، وأنظمة توزيع الطاقة.' },
        { icon: '⚙️', title: 'الأعمال الميكانيكية', desc: 'التكييف والسباكة وأنظمة الإطفاء والتركيبات الميكانيكية.' },
        { icon: '🏗️', title: 'الأعمال المدنية', desc: 'البناء الإنشائي والأساسات المدنية وتطوير البنى التحتية.' },
        { icon: '🔌', title: 'أنظمة الطاقة', desc: 'توريد وتركيب لوحات التوزيع والمحولات والمولدات وأنظمة UPS.' },
        { icon: '💡', title: 'حلول الإضاءة', desc: 'إنارة الطرق والإضاءة الصناعية وأنظمة التحكم الذكي في الإضاءة.' },
        { icon: '🛡️', title: 'الصيانة وتشغيل الأصول', desc: 'عقود الصيانة الوقائية والتصحيحية لشبكات الكهرباء.' },
      ],
      cta: 'كل الخدمات',
    },
    projects: {
